...
def index(request):
    response = {
        ...
        'terkonfirmasi': f"{Sebaran.objects.aggregate(Sum('jumlah_kasus_terkonfirmasi'))['jumlah_kasus_terkonfirmasi__sum']:,}".replace(",", "."),
        'aktif': f"{Sebaran.objects.aggregate(Sum('jumlah_kasus_aktif'))['jumlah_kasus_aktif__sum']:,}".replace(",", "."),
        'sembuh': f"{Sebaran.objects.aggregate(Sum('jumlah_sembuh'))['jumlah_sembuh__sum']:,}".replace(",", "."),
        'meninggal': f"{Sebaran.objects.aggregate(Sum('jumlah_meninggal'))['jumlah_meninggal__sum']:,}".replace(",", "."),
